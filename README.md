...
| 凝华 | 取消隐藏，图标亮起后框选图标`左上角1/4` | 
| 橙武 | 取消隐藏，图标亮起后框选图标`内部任意` | 
| 芳姿0层 | 释放3次芳姿，芳姿0层时框选图标`右下角1/4` | 
| 芳姿1层 | 释放2次芳姿，芳姿1层时框选图标`右下角1/4` | 
| 芳姿2层 | 释放1次芳姿，芳姿2层时框选图标`右下角1/4` | 
| 繁音 | 繁音好的时候，取图标内`粉色任意点` | 
| 心鼓弦 | 心鼓弦好的时候，取图标内`红色任意点` | 
| 江海 | 江海好的时候，取图标内`粉色任意点` | 
| 剑气 | 剑气好的时候，取图标内`蓝色任意点` | 
| 蓝条 | 取`蓝条20%~40%`位置的点 | 
